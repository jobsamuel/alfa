...
local DOT="%(?,%{$fg_bold[cyan]%}α,%{$fg_bold[yellow]%}α)"
if [[ "$USER" == "root" ]]; then USERCOLOR="red"; else USERCOLOR="white"; fi
...
ZSH_THEME_GIT_PROMPT_SHA_BEFORE=" %{$fg_no_bold[green]%}"
ZSH_THEME_GIT_PROMPT_SHA_AFTER="%{$fg_bold[green]%} •"
